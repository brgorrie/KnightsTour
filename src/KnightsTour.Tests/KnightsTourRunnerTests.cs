...
namespace KnightsTour.Tests
{
    public class KnightsTourRunnerTests
    {
        ...
        public void Run_ShouldCallCountToursAndWriteToConsole()
        {
            ...
            mockService
                .Setup(service => service.CountTours(It.IsAny<IChessBoard>()))
            ...
            try
            {
                ...
                // Act
                runner.Run(5); // You can put any valid values here, as they won't impact the mocked methods.

                // Assert
                mockService.Verify(service => service.CountTours(mockBoard.Object), Times.Once);
